                    ...
                    <div className="col-md-12 col-sm-12 col-xs-12 ">
                        <div className="row" Style="padding: 5px;">
                            <div className="col-md-4 col-sm-12 col-xs-12 Block" Style="padding: 15px;">
                                <strong className="fs-5">Pratik Mohite</strong><br />
                                <label className="fs-7">Store Manager</label><br />
                                <label className="fs-7">pratik@gmail.com</label>
                            </div>
                            <div className="col-md-4 col-sm-12 col-xs-12 Block" Style="padding: 15px;">
                            ...
                            <div className="col-md-4 col-sm-12 col-xs-12" Style="padding: 15px;">
                                ...
                                <label className="fs-7"> 7774997577 </label><br />
                        ...
                        <div className="row" Style="padding: 5px;">
                            <div className="col-md-4 col-sm-12 col-xs-12 Block" Style="padding: 15px;">
                                <strong className="fs-5">Mayuresh Kolekar</strong><br />
                                <label className="fs-7">Store Manager</label><br />
                                <label className="fs-7">mayuresh@gmail.com</label>
                            </div>
                            <div className="col-md-4 col-sm-12 col-xs-12 Block" Style="padding: 15px;">
                                <strong className="fs-7">GRMart-Akurdi Railway station</strong><br />
                            ...
                            <div className="col-md-4 col-sm-12 col-xs-12" Style="padding: 15px;">
                                <strong className="fs-5"> Contact </strong><br />
                                <label className="fs-7">9767239069 </label><br />
